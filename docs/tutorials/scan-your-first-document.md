...
This tutorial walks you through installing saneless, connecting it to your scanner and paperless-ngx instance, scanning your first document, and verifying it appears in paperless-ngx. By the end, you will have a working scan-to-paperless pipeline.
...
- **Python 3.12 or later** (for bare-metal install) or **Docker** (for container install).
