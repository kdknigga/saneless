...
class TestFilterEmptyPages:
    ...
    def test_filters_empty_from_mixed(self, content_page_image, empty_page_image):
    ...
    def test_no_empty_returns_all(self, content_page_image):
...
class TestThumbnailGeneration:
    ...
    def test_returns_nonempty_base64(self, content_page_image):
        """generate_thumbnail returns a non-empty base64 string."""
        result = generate_thumbnail(content_page_image)
        assert isinstance(result, str)
        assert len(result) > 0

    def test_decodes_to_valid_jpeg(self, content_page_image):
    ...
    def test_landscape_max_edge(self):
    ...
    def test_portrait_max_edge(self):
