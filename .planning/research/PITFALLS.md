...
| **PyPI trusted publishing** | Assuming it follows the repo rename | Publisher is keyed to (owner, repo, workflow filename, environment); create it for `kdknigga/scanless` before the first tag; rehearse against TestPyPI |
